            ...
            <div class="card-body">
                ...
                <form id="create-purchase-form">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control bg-light" id="order_tax" name="order_tax" readonly>
                        <div class="text-danger" id="error-order_tax"></div>
                    </div>

                    <div class="form-group mb-3">
                        <label for="order_discount">Order Discount</label>
                        <input type="number" step="0.01" class="form-control bg-light" id="order_discount" name="order_discount" readonly>
...
<script>
    ...
    async function loadDropdowns() {
        const endpoints = { store: 'stores', vendor: 'vendors', product: 'products' };
