    ...
    <script>
        ...
        function updateTotalAmount() {
            ...
            document.querySelectorAll('#items-table tbody tr').forEach(row => {
                ...
                total += subtotal;
                row.querySelector('.line-total').innerText = subtotal.toFixed(2);
            });
        ...
        document.addEventListener('DOMContentLoaded', async () => {
            ...
            document.getElementById('create-purchase-form').addEventListener('submit', async function(e) {
                ...
                ['store_id', 'vendor_id', 'purchase_date', 'total_amount'].forEach(f => {
                    const errorElem = document.getElementById(`error-${f}`);
