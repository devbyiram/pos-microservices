                    ...
                    <div class="card-body">
                        <form id="edit-purchase-form">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control" id="order_discount" name="order_discount">
                            </div>
...
<script>
    ...
    function updateTotalAmount() {
        ...
        document.querySelectorAll('#items-table tbody tr').forEach(row => {
            ...
            const taxAmount = (price * tax / 100) * qty;
            const unitCost = (price - discount) + (price * tax / 100);
        ...
        total = total - orderDiscount + orderTax + shipping;
    ...
    function addItemRow(item = null) {
        ...
        row.innerHTML = `
            ...
            <td><input type="number" name="items[][tax_amount]" class="form-control tax_amount" step="0.01" value="${item?.tax_amount || 0}" readonly></td>
            <td><input type="number" name="items[][unit_cost]" class="form-control unit_cost" step="0.01" value="${item?.unit_cost || 0}" readonly></td>
            <td><input type="number" name="items[][total_cost]" class="form-control total_cost" step="0.01" value="${item?.total_cost || 0}" readonly></td>
    ...
    async function loadPurchase() {
        ...
        document.getElementById('purchase_date').value = date.toISOString().split('T')[0];
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.getElementById('order_tax').addEventListener('input', updateTotalAmount);
        document.getElementById('shipping').addEventListener('input', updateTotalAmount);
