                    ...
                    <div class="card-body">
                        <form id="create-purchase-form">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select" id="user_id" name="user_id"></select>
...
<script>
    ...
    async function loadDropdowns() {
        ...
        for (const [key, endpoint] of Object.entries(dropdowns)) {
            try {
                ...
                if (key === 'product') {
                    ...
                    select.innerHTML = `<option disabled selected>Select ${key.charAt(0).toUpperCase() + key.slice(1)}</option>`;
                    data.forEach(item => {
